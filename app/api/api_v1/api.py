...
from app.api.api_v1.endpoints import auth, measurements, users, devices, device_stories, bgeigie_imports, ingest, radiation_index
...
api_router.include_router(radiation_index.router, prefix="", tags=["radiation_index"])
